    ...
    return (
      <div className="container">
        ...
        <div className="privacy">
          ...
          <p>Genly the playlist generator ("us", "we", or "our") operates the genly.online website (hereinafter referred
            to as the "Service").</p>
          ...
          <p>You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. However, if
            ...
            to
            manage cookies in the <a href="https://privacypolicies.com/blog/how-to-delete-cookies/">Browser Cookies
              Guide</a>.</p>
          ...
          <hr/>
          <h4>Use of Data</h4>
          <p>genly the playlist generator uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>If you are located outside Turkey and choose to provide information to us, please note that we transfer the
            data, including Personal Data, to Turkey and process it there.</p>
          <p>Your consent to this Privacy Policy followed by your submission of such information represents your
            agreement
            to that transfer.</p>
          <p>genly the playlist generator will take all steps reasonably necessary to ensure that your data is treated
          ...
          <p>genly the playlist generator may disclose your Personal Data in the good faith belief that such action is
            necessary to:</p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of genly the playlist generator</li>
